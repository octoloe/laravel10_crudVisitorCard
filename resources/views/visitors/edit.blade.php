...
@section('content')
<div class="container">
    <h3 class="text-center mt-5 mb-5">Besucherkarte Editieren</h3>
        ...
        <form action="{{ route('visitors.update', $visitor->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class=" row">
                <div class="col-5 mb-4">
                    ...
                    <img src="" id="file-preview" alt="Bild" class="rounded form-control mb-2" />
                    <input type="file" class="form-control @error('image') is-invalid @enderror"
                        value="{{ $visitor->image }}" name="image" id="image" accept="image/*"
            ...
            <div class="row">
                <div class="col mb-4">
                    ...
                    <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name"
                        id="first_name" value="{{ $visitor->first_name }}" />
            ...
            <div class=" row">
                <div class="col mb-4">
                    ...
                    <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name"
                        id="last_name" value="{{ $visitor->last_name }}" />
            ...
            <div class=" row">
                <div class="col mb-4">
                    ...
                    <input type="text" class="form-control @error('profession') is-invalid @enderror" name="profession"
                        id="profession" value="{{ $visitor->profession }}" />
            ...
            <div class=" row">
                <div class="col mb-4">
                    ...
                    <input type="text" class="form-control @error('tel_nr') is-invalid @enderror" name="tel_nr"
                        id="tel_nr" value="{{ $visitor->tel_nr }}" />
