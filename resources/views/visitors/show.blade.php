...
<div class="container">
    <h3 class="text-center mt-5 mb-5">Einzelansicht</h3>

    <div class="text-center">
        <div class="row shadow p-2">
            <div class="col text-center">
                <img src="{{ asset('images/' .$visitor->image) }}" class="img-thumbnail" width="200" alt="Bild" />

                <h5 class="text-center fw-bold fst-italic mt-3">{{ $visitor->last_name }},
                    {{ $visitor->first_name }}
                </h5>
